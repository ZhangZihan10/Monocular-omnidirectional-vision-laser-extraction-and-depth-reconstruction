...
%combined4 = [letter4, num2str(numbert)];

writeline(arduino,combined1);pause(3);%将数据以文本形式写入文件。
writeline(arduino,combined2);pause(3);
writeline(arduino,combined3);pause(3);
%writeline(arduino,combined4);pause(3);
c="m";
writeline(arduino,c);
