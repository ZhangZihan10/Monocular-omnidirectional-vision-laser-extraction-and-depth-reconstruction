...
%通过鱼眼摄像头计算方块的位置
Loc=TutorialBasic2B;%TutorialBasic1为使用平均值算法，TutorialBasic2为寻找最小值算法,TutorialBasic2Bnew使用新的激光识别算法
pot=PositionTranR2(Loc(1),Loc(2));
t = 0:0.1:6;
X1 = pot(1,1)/100;  % Z
Y1 = pot(2,1)/100; % -X
Z1 = -0.01;  % Y - GREEN
...
%%
%抓取红色
%Loc=TutorialBasic2;%TutorialBasic1为使用平均值算法，TutorialBasic2为寻找最小值算法
Loc=TutorialBasic2R;%TutorialBasic1为使用平均值算法，TutorialBasic2为寻找最小值算法
pot=PositionTranR2(Loc(1),Loc(2));
t = 0:0.1:6;
X1 = pot(1,1)/100;  % Z
Y1 = pot(2,1)/100; % -X
